...
const ContactPage = () => {
  ...
  useEffect(() => {
    document.title = `Contact — ${config.info.naam}`
  }, [config.info.naam])
  ...
  return (
    <>
      <PageHeader
        titel="Contact"
        subtitel="We horen graag van u. Neem gerust contact op."
      />
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <Input label="Telefoon (optioneel)" type="tel" {...register('telefoon')} />
                    <div>
